...
export default function AdminAssets() {
  ...
  async function createAsset(e) {
    ...
    const payload = {
      ...
      vacancy_rate_percent:
        Number(form.vacancy_rate_percent) || 0,
    };
  ...
  async function tokenize(assetId) {
    ...
    await api(`/assets/${assetId}/tokenize`, {
      method: "POST",
    });
    ...
    <Page title="Admin Assets">
      <Card>
        ...
        >
          ...
          <Input
            placeholder="Asset Type (office, warehouse, land)"
            onChange={(e) =>
              setForm({
                ...form,
          ...
          <Input
            ...
            onChange={(e) =>
              setForm({
                ...form,
                annual_yield_percent: e.target.value,
              })
            }
          />
          ...
          <Input
            ...
            onChange={(e) =>
              setForm({
                ...form,
                base_risk_level: e.target.value,
              })
            }
          />
          ...
          <Input
            ...
            onChange={(e) =>
              setForm({
                ...form,
                vacancy_rate_percent: e.target.value,
              })
            }
          />
              ...
              <div className="flex justify-between items-center">
                <div className="space-y-1">
                  ...
                  <div className="text-sm text-gray-700">
                    ...
                    • Yield {a.annual_yield_percent}% • Risk{" "}
                    {a.base_risk_level}
                  </div>
